...
export default function AboutPage() {
  return (
    <>
      ...
      <Section title="Leilani and Paul" intro="Portraits remain a TODO until approved portrait images are available.">
