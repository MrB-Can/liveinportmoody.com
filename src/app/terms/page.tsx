      ...
      <Section title="Terms and Real Estate Disclaimer" tone="white" intro={`Last updated: May 4, 2026. ${siteConfig.name} is operated by ${siteConfig.realtors}, licensed realtors with ${siteConfig.brokerageName}.`}>
        <div className="max-w-3xl space-y-8 text-sm leading-7 text-slateText">
          ...
          <div className="space-y-3">
            ...
            <p>The site may provide active listing access through approved MLS Reciprocity tools where available. It shows Paul Bennett and Leilani Fong&apos;s own recently sold listings, but does not publish third-party comparable sold data or automated valuations. Any value opinion, market comment, or property guidance provided after a form submission is contextual and may require additional property-specific review before it can be relied on.</p>
          </div>
