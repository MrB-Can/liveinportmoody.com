...
export function TeamMemberCard({ name, role, focus, note }: TeamMemberCardProps) {
  return (
    <article className="rounded-lg border border-softBorder bg-white p-6 shadow-sm">
      <div className="mb-5 grid aspect-[4/3] place-items-center rounded-md bg-[linear-gradient(135deg,#F3EFE7,#D9DED8)]" aria-label={`${name} portrait placeholder`}>
